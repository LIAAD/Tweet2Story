...
**However**, we can use a platform developed on one of our previous projects to provide us with a knowledge graph of a narrative. It uses the ".ann" file generated by Tweet2Story to generate the graph. 
